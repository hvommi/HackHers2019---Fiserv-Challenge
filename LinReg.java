...
public class LinReg {
   ...
   /**
    ...
    public double intercept() {
    	System.out.println("Values you're working with: " + alpha);
        return alpha;
    }
   ...
   /**
     ...
     */
    public double slope() {
    	System.out.println("Values you're working with: " + beta);
        return beta;
    }
   ...
   /**
     ...
     */
    public double R2() {
    	System.out.println("Values you're working with: " + R2);
        return R2;
    }
   ...
   /**
    ...
    public double interceptStdErr() {
    	System.out.println("Values you're working with: " + svar0);
   ...
   /**
    ...
    public double slopeStdErr() {
    	System.out.println("Values you're working with: " + svar1);
